...
- `/terms/` is **client-hydrated** -> every text change must edit BOTH `terms/index.html` AND the
  terms chunk `_next/static/chunks/0he1vgjwt7klq.js`, word-for-word, or hydration reverts it.
- Homepage Compare/Challenges/Instruments (incl. leverage) render from chunk
  `_next/static/chunks/0fvh0xh4dp8x2.js` - HTML-only edits get wiped on hydration.
