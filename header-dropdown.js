...
(function () {
  ...
  function injectStyles() {
    ...
    css.textContent = [
      ...
      "color:var(--t3,#fff9);font:600 .78rem var(--font-b,Inter,sans-serif);padding:6px 11px;border-radius:99px;",
      "transition:all .3s var(--ease,ease);white-space:nowrap}",
      "#" + ID + " .hd-btn:hover,#" + ID + ".hd-open .hd-btn{color:var(--t1,#fff);background:#ffffff0a}",
      "#" + ID + " .hd-chev{width:12px;height:12px;transition:transform .3s var(--ease,ease)}",
